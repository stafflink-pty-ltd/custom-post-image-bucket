...
function custom_post_image_bucket__settings_init() {
	...
	add_settings_section(
		...
		__( 'Add your Bucket details here.', 'cpib' ),
		'cpib_section_developers_callback',
		'cpib'
	);

	add_settings_field(
		'cpib_region',
		'Bucket Region (eg ap-south-1)',
		'cpib_region_callback',
		'cpib',
		'cpib_section_developers',
		array(
			'label_for' => 'cpib_region',
			'class'     => 'cpib_row',
		)
	);

	add_settings_field(
		'cpib_bucket_endpoint',
		'Bucket Endpoint (eg https://ap-south-1.linodeobjects.com/)',
		'cpib_bucket_endpoint_callback',
		'cpib',
		'cpib_section_developers',
		array(
			'label_for' => 'cpib_bucket_endpoint',
			'class'     => 'cpib_row',
		)
	);
...
function cpib_bucket_endpoint_callback( $args ) {
...
function cpib_region_callback( $args ) {
	$option = get_option( 'cpib_options' );
	?>
	<input 
		id="<?php echo esc_attr( $args['label_for'] ); ?>"
